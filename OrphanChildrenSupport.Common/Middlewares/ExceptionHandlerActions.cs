...
namespace OrphanChildrenSupport.Common.Middlewares
{
    public class ErrorHandlingMiddleware
    {
        ...
        private Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            //var result = JsonConvert.SerializeObject<Exception>(exception, new JsonSerializerOptions { WriteIndented = true });
