...
import ChildrenProfileModal from "@Components/modals/Admin/ChildrenProfileModal";
...
import ChildrenHistoryDrawer from "@Components/modals/Admin/ChildrenHistotyModal";
...
const ChildrenProfilePage: React.FC<Props> = () => {
  ...
  const requestColumns: CustomColumnType[] = [
    ...
    {
      title: "Address",
      columnSearchDataIndex: "publicAddress",
      dataIndex: "publicAddress",
      align: "center",
      ...getColumnSearchProps("publicAddress"),
      width: "19%",
      key: "publicAddress",
      render: (text: string) => convertAddressToString(text),
    },
      ...
      render: (text, record, index) => (
        <Space className="actions" style={{ gap: "0px" }}>
          <Button
            ...
            icon={<FieldTimeOutlined size={8} style={{ color: "#9da5b1" }} />}
          />
          <Button
